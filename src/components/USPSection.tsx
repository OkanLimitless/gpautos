...
export default function USPSection() {
  const items = [
    ...
    { title: 'Betrouwbaarheid', desc: 'Consistente kwaliteit en afspraken die we nakomen.', icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
    )},
  ]
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {items.map((item, idx) => (
            <motion.div
              key={item.title}
              className="p-6 bg-light rounded shadow-sonic text-text-dark border border-black/5"
            ...
            >
              ...
              <h3 className="text-xl font-semibold uppercase tracking-wide mb-2">{item.title}</h3>
