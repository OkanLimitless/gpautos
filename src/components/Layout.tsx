          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <Link href="/" className="inline-flex">
                <Image src="/logo.png" alt="GP Auto's" width={140} height={42} className="h-8 w-auto" />
              </Link>
              <p className="mt-4 text-sm text-gray-500 leading-relaxed max-w-xs">
                Specialistische autoservice in Lichtenvoorde voor de Achterhoek.
              </p>
              <div className="mt-5 flex gap-3">
                ...
                <a
                  href="https://www.facebook.com/gpautosnl"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 text-gray-500 transition-colors hover:bg-gray-200 hover:text-gray-700"
                  aria-label="Facebook"
            ...
            {/* Diensten */}
            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-4">Diensten</h3>
            ...
            {/* Regio */}
            <div>
              <h3 className="text-sm font-semibold text-gray-900 mb-4">Regio</h3>
              <ul className="space-y-3">
