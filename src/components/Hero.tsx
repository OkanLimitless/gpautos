...
export default function Hero() {
  return (
    <section className="relative min-h-[56svh] overflow-hidden bg-gray-950 text-white sm:min-h-[66svh] lg:min-h-[84svh]">
      ...
      <div className="relative container flex min-h-[56svh] flex-col justify-end pb-8 pt-24 sm:min-h-[66svh] lg:min-h-[84svh] lg:justify-center lg:pb-20">
        <div className="max-w-3xl">
          <div className="hero-reveal inline-flex items-center gap-2 border-l-2 border-red-500 pl-3 text-xs font-semibold uppercase tracking-[0.2em] text-white/72 sm:text-sm">
            <span className="inline-block h-2 w-2 rounded-full bg-red-500" />
            Autogarage in Lichtenvoorde
          </div>

          <h1 className="hero-reveal mt-4 max-w-3xl text-4xl font-bold leading-[1.02] tracking-tight sm:mt-5 sm:text-6xl lg:text-7xl [animation-delay:80ms]" style={{ textShadow: '0 2px 24px rgba(0,0,0,0.45)' }}>
            GP Auto&apos;s
          ...
          <p className="hero-reveal mt-4 max-w-xl text-base leading-7 text-white/74 sm:mt-5 sm:text-lg [animation-delay:160ms]">
            Onderhoud, diagnose, remmen en coderen voor Audi, Volkswagen, SEAT en Skoda. Duidelijk advies, gewoon in de buurt.
          </p>

          <div className="hero-reveal mt-5 grid gap-3 sm:mt-6 sm:flex [animation-delay:240ms]">
          ...
          <div className="hero-reveal mt-6 grid max-w-2xl grid-cols-2 gap-x-5 gap-y-3 border-t border-white/15 pt-4 text-sm text-white/68 sm:mt-7 sm:flex sm:flex-wrap sm:items-center sm:gap-x-7 sm:pt-5 [animation-delay:320ms]">
            <a
              href={business.googleBusinessProfileUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/82 hover:text-white"
            ...
            >
              ...
              {business.googleRating.toFixed(1)} Google · {business.googleReviewCount} reviews
            </a>
