...
export const cities: City[] = [
    ...
    },
    {
        ...
        intro: 'Voor bestuurders uit Groenlo is GP Auto\'s dichtbij genoeg voor praktisch onderhoud, maar specialistisch genoeg voor merken waarbij diagnose en VAG-coderingen echt verschil maken.',
        whyChoose: [
    ...
    },
    {
        ...
        metaDescription: "Autogarage voor Winterswijk en de Achterhoek. GP Auto's verzorgt onderhoud, diagnose en coderingen voor Audi, Volkswagen, SEAT en Skoda.",
        ...
        whyChoose: [
            ...
            'Voor VAG-rijders uit Winterswijk is het prettig dat onderhoud, diagnose en coderingen onder één dak zitten.',
        ],
        ...
        faqs: [
            ...
            {
                question: 'Kunnen jullie coderingen en regulier onderhoud combineren?',
    ...
    },
    {
        ...
        whyChoose: [
            ...
            'Voor VAG-modellen is het prettig dat diagnose, coderen, mechanica en onderhoud bij elkaar komen.',
        ],
    ...
    },
    {
        ...
        metaDescription: "Autogarage voor Borculo met VAG-specialisme. GP Auto's verzorgt onderhoud, diagnose en coderen vanuit Lichtenvoorde.",
        ...
        faqs: [
            ...
            {
                question: 'Bieden jullie ook coderingen aan?',
                answer: 'Ja, voor geschikte VAG-modellen kunnen we comfortfuncties en instellingen via VAG-COM/VCDS coderen.',
            },
        ],
    },
    {
        ...
        metaDescription: "Autogarage voor Doetinchem en de Achterhoek. GP Auto's biedt VAG onderhoud, diagnose en coderen in Lichtenvoorde.",
        ...
        whyChoose: [
            ...
            'Bij VAG-auto\'s telt vaak meer dan alleen sleutelwerk; diagnose en merkspecifieke codering zijn belangrijk.',
            'U kunt onderhoud, coderen en storingscontrole combineren in één afspraak.',
        ],
        ...
        faqs: [
            ...
            {
                question: 'Is het slim om onderhoud te combineren met coderen?',
...
export const services: Service[] = [
    {
        ...
        icon: '🔧',
        intro: 'Goed onderhoud voorkomt veel storingen. Bij VAG-auto\'s gaat het niet alleen om oliewissels, maar ook om diagnose, vervangmomenten en het totaalbeeld van de auto.',
        idealFor: [
    ...
    },
    {
        ...
        name: 'Coderen',
        shortDescription: 'VAG-COM/VCDS coderingen en functie-aanpassingen',
        longDescription: 'Met VAG-COM/VCDS kunnen we bij geschikte Audi, Volkswagen, SEAT en Skoda modellen functies activeren, instellingen aanpassen en comfortopties netjes configureren.',
        metaDescription: "Coderen in Lichtenvoorde voor geschikte VAG-auto's. GP Auto's helpt met VAG-COM/VCDS functie-aanpassingen voor Audi, Volkswagen, SEAT en Skoda.",
        icon: '⚡',
        intro: 'Veel VAG-modellen hebben functies die via codering kunnen worden ingesteld of geactiveerd. We kijken per auto wat mogelijk en verstandig is.',
        idealFor: [
            'U wilt comfortfuncties laten activeren waar uw auto technisch op voorbereid is.',
            'U zoekt hulp met VAG-COM/VCDS instellingen zonder giswerk.',
            'U wilt weten wat voor uw specifieke Audi, Volkswagen, SEAT of Skoda mogelijk is.',
        ],
        checklist: [
            'Controle van voertuig, uitvoering en beschikbare modules.',
            'Bespreking van gewenste functies en technische haalbaarheid.',
            'Heldere uitleg over wat is aangepast en wat u kunt verwachten.',
        ],
        faqs: [
            {
                question: 'Kunnen jullie elke functie activeren?',
                answer: 'Nee. Dat hangt af van uitvoering, modules en aanwezige hardware. We controleren eerst wat technisch mogelijk is.',
            },
            {
                question: 'Werken jullie met VAG-COM of VCDS?',
                answer: 'Ja. Voor geschikte VAG-modellen gebruiken we merkspecifieke diagnose- en coderingstools.',
            },
            {
                question: 'Doen jullie chiptuning?',
                answer: 'Nee. Deze dienst gaat om coderen en functie-aanpassingen, niet om vermogenssoftware of tuning.',
            },
        ],
