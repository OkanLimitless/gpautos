...
export const homeFaqs: FaqItem[] = [
  {
    question: "Wat voor autogarage is GP Auto's in Lichtenvoorde?",
    answer:
      "GP Auto's is een lokale autogarage in Lichtenvoorde voor onderhoud, reparatie, storingsdiagnose, remmen en wielophanging. De werkplaats heeft extra ervaring met Audi, Volkswagen, SEAT, Škoda en Cupra.",
  },
  {
